...
namespace App\Models {
     ...
     * @property string $remaining_letters
     * @property string $puzzle_string
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<GameSession>|GameSession wherePuzzleString($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GameSession>|GameSession whereRemainingLetters($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GameSession>|GameSession whereIsActive($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<LeaderShip>|LeaderShip whereWord($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LeaderShip>|LeaderShip whereScore($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LeaderShip>|LeaderShip whereStudentId($value)
     ...
     * @property-read int|null $gameSessions_count
     ...
     * @property mixed $score
     * @property string $word
     * @property mixed $game_session_id
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereGameSessionId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereWord($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Submission>|Submission whereScore($value)
